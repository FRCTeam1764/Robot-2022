...
public class SwerveRobotContainer {
    ...
    private void configureCoPilotButtonBindings() {
        secondaryController.getRightBumperButton().whileHeld(new ShooterCommand(robotSubsystems.shooter, robotSubsystems.shooterTopRoller, 5000, robotState.shooter));
        ...
        secondaryController.getLeftTriggerAxis().getButton(.5).whileHeld(new IntakeBallCommand(robotSubsystems.intake, 1, robotSubsystems.conveyor, 1, robotSubsystems.elevator , -0.6, robotState.intake, false));//intake
        ...
        secondaryController.getDPadButton(Direction.UP).whileHeld(new ClimberCommand(robotSubsystems.climber, 1, robotState.climber));
        secondaryController.getDPadButton(Direction.DOWN).whileHeld(new ClimberCommand(robotSubsystems.climber, -1.0, robotState.climber));
        // secondaryController.getDPadButton(Direction.LEFT).whenPressed(new GoUpCommand(robotSubsystems.climber, robotState.climber, false, 300000, false));
        ...
        secondaryController.getAButton().whenPressed(new SequentialCommandGroup(
            new PullDownCommand(robotSubsystems.climber, -0.6, robotState.climber),
            new GoUpCommand(robotSubsystems.climber, robotState.climber, false, 90000, false),
            new GoUpCommand(robotSubsystems.climber, robotState.climber, false, 250000, false)
        ));
        ...
        secondaryController.getYButton().whenPressed(new SequentialCommandGroup(
            new GoUpCommand(robotSubsystems.climber, robotState.climber, true, 380000, true),
    ...
    public Axis getPilotRightTriggerAxis() {
